 ...
 * @returns {import('@keithclark/tiny-parsers').SgmlText}
 */
 ...
 * @param {import('@keithclark/tiny-parsers').SgmlNodeList} [children] Node children
 * @returns {Element}
 */
 ...
 * @returns {import('@keithclark/tiny-parsers').SgmlDoctype}
 */
